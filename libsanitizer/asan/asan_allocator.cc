...
// static THREADLOCAL AllocatorCache cache;
    ...
    struct Allocator
    {
                       ...
                       AllocType alloc_type, bool can_fill)
        {
            ...
            uptr chunk_beg = user_beg - kChunkHeaderSize; /* 先有chunkheader,接下来才是chunk */
    ...
    uptr AsanChunkView::Beg()
    {
        return chunk_->Beg();
    }
    uptr AsanChunkView::End()
    {
        return Beg() + UsedSize();
    }
    uptr AsanChunkView::UsedSize()
    {
        return chunk_->UsedSize();
    }
    uptr AsanChunkView::AllocTid()
    {
        return chunk_->alloc_tid;
    }
    uptr AsanChunkView::FreeTid()
    {
        return chunk_->free_tid;
    }
    ...
    {
        return chunk_->alloc_context_id;
    }
    u32 AsanChunkView::GetFreeStackId()
    {
        return chunk_->free_context_id;
    }
